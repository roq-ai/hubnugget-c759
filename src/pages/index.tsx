  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Hubnugget - Bridging the gap between opportunities and seekers globally. Task management, secure payments, and a world of jobs at your fingertips, ensuring equal opportunities for all."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1487528278747-ba99ed528ebc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxqb2JzfGVufDB8fHx8MTY5Mzk4MDQ0NHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Hubnugget - Bridging the gap between opportunities and seekers globally. Task management, secure payments, and a world of jobs at your fingertips, ensuring equal opportunities for all.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Recruiter" type="recruiter" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
