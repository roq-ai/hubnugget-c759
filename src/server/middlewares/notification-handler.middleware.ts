...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'job.create': { roles: ['job-seeker'], key: 'job-posted', tenantPath: ['organization', 'job'], userPath: [] },
  'job.update': { roles: ['job-seeker'], key: 'job-updated', tenantPath: ['organization', 'job'], userPath: [] },
  'job.delete': { roles: ['job-seeker'], key: 'job-deleted', tenantPath: ['organization', 'job'], userPath: [] },
  'application.create': {
    roles: ['recruiter', 'employer'],
  ...
  'payment.update': {
    ...
    tenantPath: ['organization', 'job', 'payment'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['recruiter'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['job-seeker', 'employer', 'recruiter'];
